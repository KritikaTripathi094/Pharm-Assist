...
// --- Payment panels ---
private view.PaymentMethodPanel paymentMethodPanel;
private view.StripePayPanel stripePayPanel;
    ...
    stripePayPanel = new StripePayPanel();

    Payment.setLayout(new CardLayout());
    Payment.add(paymentMethodPanel, "paymentMethod");
    Payment.add(stripePayPanel, "stripePay");

    // Default payment screen
    showPaymentMethodPanel();

    // Attach listeners SAFELY
    paymentMethodPanel.addStripeListener(e -> onStripeSelected());
    paymentMethodPanel.addCODListener(e -> onCODSelected());
